...
export const PassRecoveryForm: FC<TPassRecoveryFormProps> = ({
  revealModal,
  closeModal,
}) => {
    ...
    <form onSubmit={handleSubmit(onSubmit)} autoComplete="off">
      <section className="field iconized__LR">
        ...
        <div className="field__input">
          <Input
            {...register('email', { value: 'test@test.com' })}
            onChangeFocus={state => {
      ...
      <div className="info__signup">
        <div className="info__signup__container">
          <Button onClick={returnToLogin} variant="ok__alt">
            Back to Sign in
          </Button>
        </div>
        <div className="info__signup__container">
          <Button onClick={proceedSignup} variant="ok">
            Send
          </Button>
        </div>
      </div>
