...
import { Accordeon, BrandIcon } from '../../elements';
    ...
    <li key={item.title}>
      <a href={item.href} title={item.title}>
        <div className="icon-socials">
          <object type="image/svg+xml" data={item.src.src} aria-label={item.title} />
        </div>
        <div />
      </a>
    </li>
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-copyright">
        <p>
          The content of this site is copyright-protected and is the property of H&M
          Hennes & Mauritz AB. Used for nonprofit educational purposes.
        </p>
      </div>
      ...
      <div className="country-info">United States | $</div>
    </footer>
  );
});
