...
export const SliderMenu: FC<TSliderMenuProps> = ({
  ...
  return (
    <div className={css.sliderMenu}>
      <button type="button" className={css.toggle} onClick={onToggleClick}>
        {title}
      </button>
      <div
        className={
          isCollapsed ? `${css.subMenuContainer} ${css.collapsed}` : css.subMenuContainer
        }
      >
        <button type="button" className={css.toggle} onClick={onToggleClick}>
          {submenuTitle}
