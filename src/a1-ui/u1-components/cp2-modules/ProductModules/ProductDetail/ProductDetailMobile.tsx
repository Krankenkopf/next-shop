...
export const ProductDetailMobile: FC<TProductDetailMobileProps> = ({
    currentArticle, articleCodes, articleTitles, onArticleVariantsToggle,
}) => {
    const isInCart = true
    ...
    return (
        <article className="product-detail-mobile__wrapper">
            {imgs.length && <figure className="product-detail-mobile__mainImg">
            ...
            {imgs.length > 1 && <section className="product-detail-mobile__otherImgs">
                {imgs.map((img, i) => {
                    if (i !== 0) return (
                        <figure key={img.url}>
            ...
            <footer className="product-detail-mobile__footer">
                <div className="product-detail-mobile__footer-inner">
                    ...
                    <div className="product-detail-mobile__footer__price-plus-cart">
                        ...
                        {isInCart && <p className="product-detail-mobile__footer__cart-info text center">In your cart</p>}
                        <div className="cart-button">
                            <Button variant={isInCart ? "cancel" : "ok"}
                            orientation="right"
                            ...
                            <div className="iconized right wide">
                                {isInCart
                                    ...
                                    <Icon name="cart-shopping" />
                                        <Icon name="xmark" primaryColor={IconColor.ERROR} secondaryColor={IconColor.ERROR} />
                                        <Icon name="circle" size="max" primaryColor={IconColor.ERROR} secondaryColor={IconColor.ERROR} />
                                    </>
                                    : <Icon name="cart-plus" size="full" primaryColor={IconColor.OK} secondaryColor={IconColor.INITIAL} />}
                            </div>
                        </div>
