...
export const Popup: FC<TPopupProps> = ({ isOpen, modalType, current, scrollLock, layout, onClose, children }) => {
    ...
    useLayoutEffect(() => { // this used because on closing modal with scrollbar animation begin faster than
