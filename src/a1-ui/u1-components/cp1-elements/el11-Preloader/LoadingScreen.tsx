...
type TLoadingScreenProps = {
    stage: "loading" | "initialization" | "complete"
}
//fill="url(#logo-gradient)"
//configured to hmproject
export const LoadingScreen: FC<TLoadingScreenProps> = ({ stage }) => {
    return <div className={stage !== "complete" ? css.screen : `${css.screen} ${css.out}`}>
        <div className={css.fillerTop}></div>
        <div className={css.fillerTop}></div>
        <div className={css.fillerTop}></div>
        <div className={css.fillerMidLeft}></div>
        <div className={css.fillerMidRight}></div>
        <div className={css.fillerBottom}></div>
        <div className={css.fillerBottom}></div>
        <div className={css.fillerBottom}></div>
        <div className={stage !== "complete" ? css.splash : `${css.splash} ${css.out}`}>
            <div className={css.fillerLogoTop}></div>
            <div className={css.logo}>
                <svg width="370" height="244" viewBox="-20 -20 404 278" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <defs>
                        {stage !== "complete" &&
                            <>
                                <linearGradient id="logo-gradient">
                                    <stop offset="0%" stopColor="#ff3b48" stopOpacity={1}
                                        className={css.stop_1} />
                                    <stop offset="50%" stopColor="#e50010" stopOpacity={1}
                                        className={css.stop_2} />
                                    <stop offset="100%" stopColor="#ff0000" stopOpacity={1}
                                        className={css.stop_3} />
                                </linearGradient>
